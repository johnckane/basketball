...
```{r}
library(tidyverse)
results <- read_csv(file = "/home/john/basketball/march_madness/2018/data/tourney_results.csv")
seeds <- read_csv(file = "/home/john/basketball/march_madness/2018/data/tourney_seeds.csv")
slots <- read_csv(file = "/home/john/basketball/march_madness/2018/data/tourney_slots.csv")
```
